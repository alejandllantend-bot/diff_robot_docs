...
![](/Gazebo/imagenes_G/gz.png)

Una vez aquí, si haces clic en la opción que dice **"Empty"** (Entorno Vacío) y posteriormente en el botón **"Run"**, entrarás al espacio tridimensional de trabajo, que inicialmente consistirá en una cuadrícula plana al infinito. En este ambiente es donde pondremos a prueba la física de nuestro robot más adelante a través de sus propias herramientas de desarrollo.
...
Con esta base lista, estás preparado para pasar a la siguiente etapa: aprender a trasladar la maquinaria virtual que hemos programado hacia el interior de este simulador de gravedad usando herramientas de integración.