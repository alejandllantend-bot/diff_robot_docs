...
Abre la cabecera general de tu archivo `my_car.xacro` (junto al bloque de propiedades creados en las lecciones previas) y añade esta nueva variable numérica asignándole el valor referencial `0.2`:
